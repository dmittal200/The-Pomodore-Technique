...
title_L = Label(text="TIMER", fg=GREEN, bg=YELLOW, font=(FONT_NAME,40, "bold"))
...
check_L = Label(text="",fg=GREEN,bg=YELLOW,font=(FONT_NAME,30,"bold"))
